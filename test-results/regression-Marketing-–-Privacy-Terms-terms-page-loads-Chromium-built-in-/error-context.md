...
- Name: regression.spec.ts >> Marketing – Privacy & Terms >> terms page loads
- Location: tests\e2e\regression.spec.ts:70:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/terms
Call log:
  - navigating to "https://thecareersetu.in/terms", waiting until "load"
