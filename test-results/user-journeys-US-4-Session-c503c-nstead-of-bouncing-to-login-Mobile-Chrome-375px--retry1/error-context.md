...
- Name: user-journeys.spec.ts >> US-4 Session persists across navigation (redirect-loop regression) >> after login, a protected route loads instead of bouncing to /login
- Location: tests\e2e\user-journeys.spec.ts:86:7
...
- generic [active] [ref=e1]:
  - generic [ref=e5]:
    - link "CareerSetu CareerSetu" [ref=e6] [cursor=pointer]:
      - /url: /
      - img "CareerSetu" [ref=e7]
      - generic [ref=e8]: CareerSetu
    - generic [ref=e9]:
      - generic [ref=e10]:
        - heading "Welcome back" [level=1] [ref=e11]
        - paragraph [ref=e12]: Sign in to continue your interview prep
      - generic [ref=e13]:
        - generic [ref=e14]:
          - generic [ref=e15]:
            - generic [ref=e16]: Email
            - textbox "you@example.com" [ref=e17]: you+e2e@example.com
          - generic [ref=e18]:
            - generic [ref=e19]:
              ...
              - link "Forgot password?" [ref=e21] [cursor=pointer]:
                - /url: /forgot-password
            - generic [ref=e22]:
              - textbox "Your password" [ref=e23]: yourpassword
