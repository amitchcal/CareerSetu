...
- Name: regression.spec.ts >> Auth guard – unauthenticated redirects >> /subscription → redirects to /login
- Location: tests\e2e\regression.spec.ts:109:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/subscription
Call log:
  - navigating to "https://thecareersetu.in/subscription", waiting until "load"
