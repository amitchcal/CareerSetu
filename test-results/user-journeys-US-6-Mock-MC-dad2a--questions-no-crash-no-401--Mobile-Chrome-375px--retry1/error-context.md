...
- Name: user-journeys.spec.ts >> US-6 Mock MCQ test >> configure and start — starts, or gracefully reports no questions (no crash / no 401)
- Location: tests\e2e\user-journeys.spec.ts:124:7
