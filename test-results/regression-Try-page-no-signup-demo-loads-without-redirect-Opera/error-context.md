...
- Name: regression.spec.ts >> Try page (no-signup demo) >> loads without redirect
- Location: tests\e2e\regression.spec.ts:166:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/try
Call log:
  - navigating to "https://thecareersetu.in/try", waiting until "load"
