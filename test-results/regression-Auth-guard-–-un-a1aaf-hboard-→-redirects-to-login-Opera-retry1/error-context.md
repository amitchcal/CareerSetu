...
- Name: regression.spec.ts >> Auth guard – unauthenticated redirects >> /dashboard → redirects to /login
- Location: tests\e2e\regression.spec.ts:109:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/dashboard
Call log:
  - navigating to "https://thecareersetu.in/dashboard", waiting until "load"
