...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 items-center justify-between py-4 text-left text-sm font-medium text-gray-900 transition-all hover:text-indigo-600 [&[data-state=open]>svg]:rotate-180',
        className
      )}
      {...props}
    >
