        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 print:hidden">
              <Link href="/interview/new" className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3.5 text-sm font-semibold text-white hover:bg-indigo-700 transition-colors">
