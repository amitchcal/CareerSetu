...
- Name: regression.spec.ts >> Auth guard – unauthenticated redirects >> /profile → redirects to /login
- Location: tests\e2e\regression.spec.ts:109:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/profile
Call log:
  - navigating to "https://thecareersetu.in/profile", waiting until "load"
