...
- Name: regression.spec.ts >> Marketing – Pricing >> loads and shows plan cards
- Location: tests\e2e\regression.spec.ts:47:7
...
- generic [ref=e2]:
  - img [ref=e4]
  - generic [ref=e50]:
    - heading "This site can’t be reached" [level=1] [ref=e51]
    - paragraph [ref=e53]: Check if there is a typo in thecareersetu.in.
    - generic [ref=e57]:
      - generic [ref=e58]:
        - heading "Try:" [level=4] [ref=e59]
        - list [ref=e60]:
          - listitem [ref=e61]:
            - link "Running Windows Network Diagnostics" [ref=e62] [cursor=pointer]:
              - /url: javascript:diagnoseErrors()
          - listitem [ref=e63]: Changing DNS over HTTPS settings
      - generic [ref=e64]: DNS_PROBE_FINISHED_NXDOMAIN
    - generic [ref=e65]:
      - heading "Check your DNS over HTTPS settings" [level=4] [ref=e66]
      - paragraph [ref=e67]: Go to Opera > Preferences… > System > Use DNS-over-HTTPS instead of the system’s DNS settings and check your DNS-over-HTTPS provider.
    - generic [ref=e69]:
      - textbox [active] [ref=e72]: thecareersetu.in
