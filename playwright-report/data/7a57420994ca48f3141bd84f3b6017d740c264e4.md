...
- Name: regression.spec.ts >> Auth – Login / Signup >> signup page loads without redirect
- Location: tests\e2e\regression.spec.ts:87:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/signup
Call log:
  - navigating to "https://thecareersetu.in/signup", waiting until "networkidle"
...
- generic [ref=e2]:
  - img [ref=e4]
  - generic [ref=e48]:
    - heading "This site can’t be reached" [level=1] [ref=e49]
    - paragraph [ref=e51]: Check if there is a typo in thecareersetu.in.
    - generic [ref=e55]:
      - generic [ref=e56]:
        - heading "Try:" [level=4] [ref=e57]
        - list [ref=e58]:
          - listitem [ref=e59]:
            - link "Running Windows Network Diagnostics" [ref=e60] [cursor=pointer]:
              - /url: javascript:diagnoseErrors()
          - listitem [ref=e61]: Changing DNS over HTTPS settings
      - generic [ref=e62]: DNS_PROBE_FINISHED_NXDOMAIN
    - generic [ref=e63]:
      - heading "Check your DNS over HTTPS settings" [level=4] [ref=e64]
      - paragraph [ref=e65]: Go to Opera > Preferences… > System > Use DNS-over-HTTPS instead of the system’s DNS settings and check your DNS-over-HTTPS provider.
    - generic [ref=e67]:
      - textbox [active] [ref=e70]: thecareersetu.in
