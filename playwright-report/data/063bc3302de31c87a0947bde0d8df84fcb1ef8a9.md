...
- Name: regression.spec.ts >> Marketing – Privacy & Terms >> privacy page loads
- Location: tests\e2e\regression.spec.ts:66:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/privacy
Call log:
  - navigating to "https://thecareersetu.in/privacy", waiting until "load"
...
- generic [ref=e2]:
  - img [ref=e4]
  - generic [ref=e71]:
    - heading "This site can’t be reached" [level=1] [ref=e72]
    - paragraph [ref=e74]: Check if there is a typo in thecareersetu.in.
    - generic [ref=e78]:
      - generic [ref=e79]:
        - heading "Try:" [level=4] [ref=e80]
        - list [ref=e81]:
          - listitem [ref=e82]:
            - link "Running Windows Network Diagnostics" [ref=e83] [cursor=pointer]:
              - /url: javascript:diagnoseErrors()
          - listitem [ref=e84]: Changing DNS over HTTPS settings
      - generic [ref=e85]: DNS_PROBE_FINISHED_NXDOMAIN
    - generic [ref=e86]:
      - heading "Check your DNS over HTTPS settings" [level=4] [ref=e87]
      - paragraph [ref=e88]: Go to Opera > Preferences… > System > Use DNS-over-HTTPS instead of the system’s DNS settings and check your DNS-over-HTTPS provider.
    - generic [ref=e90]:
      - textbox [active] [ref=e93]: thecareersetu.in
