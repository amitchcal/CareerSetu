...
- Name: regression.spec.ts >> Auth guard – unauthenticated redirects >> /reports → redirects to /login
- Location: tests\e2e\regression.spec.ts:109:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://thecareersetu.in/reports
Call log:
  - navigating to "https://thecareersetu.in/reports", waiting until "load"
